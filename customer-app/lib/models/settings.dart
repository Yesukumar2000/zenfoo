...
class SettingsData {
  ...
  String? referralCreditFirstOrder;
  String? referralMinOrderAmount;
  ...
  String? storePlaceholderImgFood;
  String? storePlaceholderImgVeg;
  String? storePlaceholderImgGrocery;
  String? storePlaceholderImgMeat;
  String? storePlaceholderImgSupermart;
  ...
  SettingsData({
    ...
    this.storePlaceholderImgFood,
    this.storePlaceholderImgVeg,
    this.storePlaceholderImgGrocery,
    this.storePlaceholderImgMeat,
    this.storePlaceholderImgSupermart,
    // this.guestCart,
  });
  ...
  SettingsData.fromJson(Map<String, dynamic> json) {
    ...
    referralCreditFirstOrder = json['referral_credit_first_order']?.toString();
    referralMinOrderAmount = json['referral_min_order_amount']?.toString();
    ...
    defaultCity = json['default_city'] != null
        ...
        : null;
    favoriteProductIds = (json['favorite_product_ids'] as List<dynamic>?)?.map((e) => e.toString()).toList() ?? [];
    // Null-safe: these rows may not exist in the settings table, and a bare
    // .toString() on the missing key yields the literal string "null", which
    // then survives every `?? ""` and empty-check downstream.
    ...
    storePlaceholderImgFood = json['store_placeholder_img_food']?.toString();
    storePlaceholderImgVeg = json['store_placeholder_img_veg']?.toString();
    storePlaceholderImgGrocery = json['store_placeholder_img_grocery']?.toString();
    storePlaceholderImgMeat = json['store_placeholder_img_meat']?.toString();
    storePlaceholderImgSupermart = json['store_placeholder_img_supermart']?.toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['referral_credit_first_order'] = this.referralCreditFirstOrder;
    data['referral_min_order_amount'] = this.referralMinOrderAmount;
    ...
    data['phone_auth_password'] = this.phoneAuthPassword;
