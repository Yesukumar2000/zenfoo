...
class IncentiveIssuesScreen extends StatefulWidget {
  const IncentiveIssuesScreen({super.key});

  @override
  State<IncentiveIssuesScreen> createState() => _IncentiveIssuesScreenState();
}

class _IncentiveIssuesScreenState extends State<IncentiveIssuesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<PayoutIssuesProvider>().getIncentiveWeeks();
    });
  }
  ...
  void _showImagePicker() {
    ...
    ImagePickerBottomSheet.show(
      ...
      title:
          languageProvider.getTranslatedText('upload_incentive_issue_evidence'),
    );
  }
        ...
        children: [
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Container(
                        ...
                        child: Consumer<PayoutIssuesProvider>(
                          builder: (context, provider, child) {
                            if (provider.getIncentiveWeeksState.status ==
                                ApiStatus.loading) {
                              return const Center(
                                child: SizedBox(
                                  width: 20,
                            ...
                            final weekModel =
                                provider.getIncentiveWeeksState.data != null
                                    ? WeekModel.fromJson(
                                        provider.getIncentiveWeeksState.data)
                                    : null;
                  ...
                  // Incentive Summary and Transactions
                  if (_selectedWeek != null)
                    Consumer<PayoutIssuesProvider>(
                      builder: (context, provider, child) {
                        if (provider.getWeekIncentiveTransactionsState.status ==
                            ApiStatus.loading) {
                          return const Center(
                            child: Padding(
                        ...
                        final transactionModel = provider
                                    .getWeekIncentiveTransactionsState.data !=
                                null
                            ? PayoutWeekTransactionModel.fromJson(
                                provider.getWeekIncentiveTransactionsState.data)
                            : null;
          ...
          Padding(
            ...
            child: Consumer<PayoutIssuesProvider>(
              builder: (context, provider, child) {
                final isLoading =
                    provider.incentiveBankState.status == ApiStatus.loading;
                return CustomButton(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                languageProvider.getTranslatedText('incentive_summary'),
                style: GoogleFonts.inter(
                  color: colorScheme.textPrimary,
                  fontSize: 16,
  ...
  Future<void> _handleSubmit() async {
    ...
    if (mounted) {
      if (provider.incentiveBankState.status == ApiStatus.success) {
        Navigator.push(
          context,
          MaterialPageRoute(
