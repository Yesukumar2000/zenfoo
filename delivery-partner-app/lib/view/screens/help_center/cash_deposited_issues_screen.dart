...
class CashDepositedIssuesScreen extends StatefulWidget {
  final String issueType;

  const CashDepositedIssuesScreen({
    super.key,
    required this.issueType,
  });

  @override
  State<CashDepositedIssuesScreen> createState() =>
      _CashDepositedIssuesScreenState();
}

class _CashDepositedIssuesScreenState extends State<CashDepositedIssuesScreen> {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => const DriverIssuesScreen(
                            fixedIssueType: 'cash_deposit_issue'),
                      ),
                    );
                  },
                  child: Container(
