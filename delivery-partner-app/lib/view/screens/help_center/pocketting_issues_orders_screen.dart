...
import 'package:zenfoo_partner/view/screens/help_center/pocketting_issues_screen.dart';

import '../../../providers/language_provider.dart';

class PocketOrderIssuesScreen extends StatefulWidget {
  const PocketOrderIssuesScreen({super.key});

  @override
  State<PocketOrderIssuesScreen> createState() =>
      _PocketOrderIssuesScreenState();
}

class _PocketOrderIssuesScreenState extends State<PocketOrderIssuesScreen> {
  int? _expandedIndex;
      ...
      body: Column(
        children: [
          AppHeader(
            ...
            title: languageProvider.getTranslatedText('pocketing_issues'),
            showBackButton: true,
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => const DriverIssuesScreen(
                        fixedIssueType: 'pocketing_issue'),
                  ),
                );
              },
              child: Container(
              ...
              child: OutlinedButton(
                onPressed: () async {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PockettingIssuesScreen(
