...
class _LocationPickerScreenState extends State<LocationPickerScreen>
  ...
  Future<void> _loadMapStyle() async {
    try {
      ...
      final themeFile = themeProvider.isDarkMode
  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      ...
      if (permission.isGranted) {
        ...
        cameraPosition = const CameraPosition(target: defaultPoint, zoom: 18);
  ...
  Future<void> _selectPrediction(String placeId, String description) async {
    ...
    if (details?.latLng != null) {
      final target =
          LatLng(details!.latLng!.lat, details.latLng!.lng);
                            ...
                            Container(
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (ctx, i) {
                                  ...
                                  final displayText = suggestion.fullText;
                        ...
                        onPressed: currentPoint == null
                            ...
                            : () {
                                ...
                                Navigator.pop(context, {
                                  ...
                                  "building_name": _pickedBuildingName ?? "",
                                });
                              },
                        child: Text(
                          "Confirm Location",
