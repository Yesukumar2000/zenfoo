                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <span class="pull-right">
                                ...
                                <router-link to="/languages/create" class="btn btn-primary" v-if="$can('language_create')" v-b-tooltip.hover  :title="__('add_language')">{{ __('add_language') }}</router-link>
                            </span>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <b-table
                                ...
                                <template #cell(actions)="row">
                                    <button v-if="$can('language_update')" class="btn btn-sm btn-primary" @click="edit_record = row.item" v-b-tooltip.hover :title="__('edit')" ><i class="fa fa-pencil-alt"></i></button>
                                    <button v-if="$can('language_delete')" class="btn btn-sm btn-danger" @click="deleteRecord(row.index,row.item.id)" v-b-tooltip.hover :title="__('delete')"><i class="fa fa-trash"></i></button>
