                    ...
                    <div class="card-body">
                        ...
                        <b-table
                            ...
                            <template #cell(status)="row">
                                ...
                                <span v-else-if="row.item.status === 2" class="badge bg-success">{{ __('approved') }}</span>
                                <span v-else-if="row.item.status === 3" class="badge bg-danger">{{ __('rejected') }}</span>
                                <span v-else-if="row.item.status === 4" class="badge bg-info">{{ __('delivery_boy_assigned') }}</span>
                                <span v-else-if="row.item.status === 5" class="badge bg-primary">{{ __('out_for_pickup') }}</span>
                                <span v-else-if="row.item.status === 6" class="badge bg-secondary">{{ __('received_from_customer') }}</span>
                                <span v-else-if="row.item.status === 7" class="badge bg-danger">{{ __('cancelled') }}</span>
                                <span v-else-if="row.item.status === 8" class="badge bg-dark">{{ __('return_to_seller') }}</span>
