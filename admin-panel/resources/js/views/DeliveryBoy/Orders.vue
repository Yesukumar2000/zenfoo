<template>
    <div>
        <div class="page-heading">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><router-link to="/delivery_boy">{{ __('dashboard') }}</router-link></li>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <router-link to="/delivery_boy" class="btn btn-secondary btn-sm">
                        ...
                        <div class="row mb-2">
                            ...
                            <b-tabs title="" active >
                                ...
                                <b-row>
                                    ...
                                    <div class="col-md-4 text-success h6">Total Final Amount:- {{ $currency }} {{ remaining_final }}</div>
                                </b-row>
                                <b-row>
    ...
    data: function() {
        return {
            ...
            orderFields: [
                ...
                { key: 'total_vendor_wait_charge', label: 'Wait Bonus ('+ this.$currency +')', sortable: true, class: 'text-center' },

                { key: 'wallet_balance', label: __('wallet_used')+'('+ this.$currency +')', sortable: true, class: 'text-center' },
                { key: 'remaining_final', label: 'F.Total('+ this.$currency +')', sortable: true, class: 'text-center' },
