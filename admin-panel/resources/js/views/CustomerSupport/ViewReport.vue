<template>
    <div>
        <div class="page-heading">
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Report Details #{{ reportId }}</h3>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><router-link to="/dashboard">{{ __('dashboard') }}</router-link></li>
                                <li class="breadcrumb-item"><router-link to="/customer-support">Customer Support</router-link></li>
                                <li class="breadcrumb-item active" aria-current="page">Report #{{ reportId }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <router-link to="/customer-support" class="btn btn-secondary btn-sm">
            ...
            <section class="section" v-else-if="report">
                <!-- Report Summary Card -->
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <span :class="getReportTypeBadgeClass(report.report_type)" class="badge">{{ report.report_type === 'missing' ? 'Item Missing' : 'Wrong Item' }}</span>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <p class="fw-bold">
                                    <router-link :to="'/orders/view/' + report.order_id">#{{ report.order_id }}</router-link>
                                </p>
                            </div>
                            <div class="col-md-3">
                ...
                <!-- Order Details Card -->
                <div class="card" v-if="report.order_details">
                    <div class="card-header">
                ...
                <!-- Reported Items Card -->
                <div class="card" v-if="report.selected_items && report.selected_items.length">
                    <div class="card-header">
                            ...
                            <div v-for="(storeItem, storeIndex) in report.selected_items" :key="'store-' + storeIndex" class="mb-4 store-item-card">
                                ...
                                <b-table
                                    ...
                                    <template #cell(sub_total)="row">
                                        {{ $currency }}{{ row.item.sub_total }}
                                    </template>
                                </b-table>
                                <!-- Customer uploaded images -->
                                <div v-if="storeItem.image_urls && storeItem.image_urls.length" class="mt-3">
                                    <p class="text-muted mb-2"><strong>Customer Uploaded Images</strong></p>
                                    <div class="row">
                                        <div class="col-md-3 col-6 mb-3" v-for="(image, imgIndex) in storeItem.image_urls" :key="'missing-img-' + imgIndex">
                                            <img :src="image" class="img-thumbnail" alt="Customer uploaded image" @click="openImageModal(image)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card" v-if="report.selected_combo_items && report.selected_combo_items.length">
                    <div class="card-header">
                        ...
                        <div v-if="report.report_type === 'missing'">
                            <div v-for="(combo, comboIndex) in report.selected_combo_items" :key="'combo-' + comboIndex" class="mb-4 store-item-card">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-3">
                                        <small class="text-muted">Sub Total:</small> {{ $currency }}{{ combo.sub_total }}
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <!-- Customer uploaded images -->
                                <div v-if="combo.image_urls && combo.image_urls.length" class="mt-3">
                                    <p class="text-muted mb-2"><strong>Customer Uploaded Images</strong></p>
                                    <div class="row">
                                        <div class="col-md-3 col-6 mb-3" v-for="(image, imgIndex) in combo.image_urls" :key="'missing-combo-img-' + imgIndex">
                                            <img :src="image" class="img-thumbnail" alt="Customer uploaded image" @click="openImageModal(image)">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card" v-if="hasDeliveryImages">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                ...
                                <router-link to="/customer-support" class="btn btn-secondary ms-2">Back to List</router-link>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div>
                                            ...
                                            <span v-if="change.refund_amount > 0" class="badge bg-success">
                                                Refund: {{ $currency }}{{ change.refund_amount }}
                                            </span>
                                        </div>
            ...
            <section class="section" v-else>
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <router-link to="/customer-support" class="btn btn-primary">Back to List</router-link>
                    </div>
                </div>
            </section>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            statusOptions: [
                ...
                // { value: 5, text: 'Driver Took Item' },
                // { value: 6, text: 'Driver Returned Item' },
    ...
    methods: {
        ...
        updateReport() {
            // Validate admin remarks is required
        ...
        getReportTypeBadgeClass(type) {
            return type === 'missing' ? 'bg-primary' : 'bg-warning';
        },
