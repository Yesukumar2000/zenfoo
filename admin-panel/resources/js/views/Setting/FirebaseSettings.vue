                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="fcm_vapid_key">Web Push VAPID Key</label>
                                        <input type="text" class="form-control" name="fcm_vapid_key" id="fcm_vapid_key" v-model="firebase.fcm_vapid_key" placeholder="Enter web push certificate key pair.">
                                        <small class="text-muted">Firebase Console &rarr; Project Settings &rarr; Cloud Messaging &rarr; Web Push certificates. Required for browser notifications in this panel.</small>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label for="jsonFile">{{ __('firebase_json_file') }} 
                                            <span v-if="fileExists" class="text-success ms-2">
                                                <i class="fa fa-check-circle"></i> File exists
                                            </span>
                                            <span v-else class="text-danger ms-2">
                                                <i class="fa fa-times-circle"></i> File not exists
                                            </span>
                                        </label>
...
export default {
    ...
    methods: {
        ...
        handleFileUpload() {
            ...
            // Update file status when new file is selected
            this.fileExists = this.firebase.jsonFile ? true : false;
        },
