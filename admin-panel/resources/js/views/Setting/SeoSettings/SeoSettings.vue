                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span class="pull-right">
                                <button class="btn btn-primary"  @click="create_new=true" v-b-tooltip.hover :title="__('add_seo_page')" v-if="$can('category_create')">{{ __('add_seo_page') }}</button>
                            </span>
                        </div>
                        <div class="card-body">
                            <b-row class="mb-2">
                                ...
                                <b-col md="1" class="text-center">
                                    <button class="btn btn-primary btn_refresh" v-b-tooltip.hover :title="__('refresh')" @click="getSeoSettings()">
                            ...
                            <b-table
                                ...
                                <template #cell(actions)="row">
                                    ...
                                    <button class="btn btn-sm btn-danger" @click="deleteSeoSettings(row.index,row.item.id)" v-if="$can('category_delete')" v-b-tooltip.hover :title="__('delete')"><i class="fa fa-trash"></i></button>
                                </template>
