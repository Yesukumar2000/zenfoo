<template>
    <div>
        <div class="page-heading">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <router-link to="/manage_products" class="btn btn-secondary btn-sm">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="pull-right">
                            <button class="btn btn-primary"  @click="create_new=true" >{{ __('add_unit') }}</button><!-- v-if="$can('unit_create')" -->
                        </span>
                    </div>
                    <div class="card-body">
                        ...
                        <b-table
                            ...
                            <template #cell(actions)="row">
                                <button class="btn btn-sm btn-primary" @click="edit_record = row.item"  v-b-tooltip.hover :title="__('edit')"><i class="fa fa-pencil-alt"></i></button><!-- v-if="$can('unit_update')" -->
