                        ...
                        <div class="card-body">
                            ...
                            <b-row class="mb-2">
                                ...
                                <b-col md="2">
                                    ...
                                    <select id="brand_id" name="brand_id" @change="getRecords()"
                                            v-model="brand_id" class="form-control form-select">
                                ...
                                <template v-if="$roleSeller == login_user.role.name">
                                    ...
                                    <input type="hidden" v-model="seller" >
                                </template>
                                <!-- <template v-else>
                                    <b-col md="3">
                                ...
                                <b-table
                                    ...
                                    <template #cell(approve_toggle)="row">
                                        <a class="btn btn-sm" @click="updateApproveProduct(row.index, row.item.id)">
                                            <span class="primary-toggal" v-if="row.item.is_approved == 1"><i
                                                class="fa fa-toggle-on fa-2x"></i></span>
                                            <span class="text-danger" v-else><i
                                                class="fa fa-toggle-off fa-2x"></i></span>
                                        </a>
...
export default {
    ...
    created: function () {
        ...
        // Check if store_id exists in URL query parameters
    ...
    watch: {
        '$route.query.store_id': function(newStoreId, oldStoreId) {
    ...
    methods: {
        ...
        getBrands() {
            ...
            axios.get(this.$apiUrl + '/products/brands/get', { params })
            .then((res) => {
