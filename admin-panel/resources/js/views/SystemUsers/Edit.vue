        ...
        <form ref="my-form" @submit.prevent="saveRecord">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-select" id="role" v-model="system_user.role_id" :disabled="system_user.id === 1">
                        <option value="">Select User Role</option>
                        <option v-for="role in roles" :value="role.id" v-if="role.name !== 'Super Admin'">{{role.name}}</option>
                    </select>
                    <small v-if="system_user.id === 1" class="text-muted">Role cannot be changed for the main Admin</small>
                </div>
