                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <span class="pull-right">
                                <router-link to="/countries/create" class="btn btn-primary" v-if="$can('country_create')" v-b-tooltip.hover  :title="__('add_country')">{{ __('add_country') }}</router-link>
                            </span>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <b-table
                                ...
                                <template #cell(logo)="row">
                                    ...
                                    <img :src="$mediaUrl(row.item.logo)" height="50" v-else/>
                                </template>
                                ...
                                <template #cell(actions)="row">
                                    <button v-if="$can('country_update')" class="btn btn-sm btn-primary" @click="edit_record = row.item" v-b-tooltip.hover :title="__('edit')" ><i class="fa fa-pencil-alt"></i></button>
                                    <button v-if="$can('country_delete')" class="btn btn-sm btn-danger" @click="deleteRecord(row.index,row.item.id)" v-b-tooltip.hover :title="__('delete')"><i class="fa fa-trash"></i></button>
                                </template>
                            </b-table>
                            <b-row>
