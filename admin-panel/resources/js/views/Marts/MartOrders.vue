<template>
    <div>
        <div class="page-heading">
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><router-link to="/marts">Marts</router-link></li>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <router-link to="/marts" class="btn btn-secondary btn-sm">
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Super Mart Orders</h4>
                    </div>
                    <div class="card-body">
                        <div class="row mb-2">
                            <b-col md="3">
                            ...
                            <b-col md="3">
                                <h6 class="box-title" for="seller">Mart</h6>
                                <select name="seller" id="seller" v-model="seller" @change="handleFilterChange()" class="form-control form-select">
                                    ...
                                    <option v-for="mart in marts" :value="mart.id" :key="mart.id">{{ mart.name }}</option>
                                </select>
                            </b-col>
                            <b-col md="2">
                                ...
                                <select id="status" name="status" v-model="status" @change="handleFilterChange()" class="form-control form-select">
                                    ...
                                    <option v-for="st in statuses" :value="st.id" :key="st.id">{{ st.status }}</option>
                                </select>
                            </b-col>
                            <b-col md="2">
                        ...
                        <div class="table-responsive mt-3">
                            <b-table
                                ...
                                <template #cell(seller_name)="row">
                                    <span v-if="row.item.seller_name && row.item.seller_name !== ''">
    ...
    data: function() {
        return {
            ...
            orderFields: [
                ...
                { key: 'seller_name', label: 'Mart', sortable: false, class: 'text-center' },
    ...
    methods: {
        ...
        getMarts() {
            axios.get(this.$apiUrl + '/marts')
                .then((response) => {
                    this.marts = response.data.data;
                })
                .catch(() => {
                    this.showError("Unable to load marts");
                });
        },
        getOrderStatus() {
        ...
        getOrders() {
            ...
            const param = {
                ...
                seller: this.seller,
                status: this.status,
                store_id: 17, // Super Mart store_id
