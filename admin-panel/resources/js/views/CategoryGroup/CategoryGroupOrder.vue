        ...
        <div class="page-heading">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Category Group Order</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><router-link to="/dashboard">{{ __('dashboard') }}</router-link></li>
                            <li class="breadcrumb-item active" aria-current="page">Category Group Order</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 col-md-12 order-md-1 order-last">
                    <div class="card">
                        <div class="card-header">
                            <h4>Category Group Order List</h4>
                        </div>
                        <div class="card-body">
                            <!-- Filter Dropdown -->
                            <div class="row mb-4">
                            ...
                            <b-row>
                                <b-col md="6" style="overflow-y:scroll;height:600px;">
                                    <div v-if="!store_id" class="alert alert-info">
                                        Please select a Store to view Category Groups.
                                    </div>
                                    <ul v-else id="sortable-row" class="list-group">
                                        <draggable class="list-group" tag="ul" v-model="list" v-bind="dragOptions" :move="onMove" animation="200"
                                                   @start="isDragging=true" @end="isDragging=false" @change="updateCategoryGroupOrder()">
...
export default {
    ...
    methods: {
        ...
        getCategoryGroups(){
            ...
            this.isLoading = true;
            axios.get(this.$apiUrl + '/group-category/row_order', {
        ...
        updateCategoryGroupOrder(){
            ...
            this.isLoading = true;
            let formData = {
                category_groups: this.list,
                store_id: this.store_id
            };
            let url = this.$apiUrl + '/group-category/updateOrder';
