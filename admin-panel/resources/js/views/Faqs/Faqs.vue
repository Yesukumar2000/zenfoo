                    ...
                    <div class="card-body">
                        ...
                        <b-table
                            ...
                            <template #cell(role)="row">
                                <span :class="roleClass(row.item.role)" class="badge">
                                    {{ row.item.role ? row.item.role.charAt(0).toUpperCase() + row.item.role.slice(1) : '-' }}
                                </span>
                            </template>
...
export default {
    ...
    methods: {
        ...
        roleClass(role) {
            const map = { seller: 'bg-warning text-dark', driver: 'bg-info text-white', customer: 'bg-success text-white' };
