        ...
        getSettings() {
            axios.get(this.$apiUrl + '/web_settings').then((response) => {
                ...
                if(this.settings.web_logo != ""){
                    this.web_logo_url = this.$mediaUrl(this.settings.web_logo);
                }else{
                    this.web_logo_url = this.$baseUrl + '/images/logo.png';
                }
                this.favicon_url = this.$mediaUrl(this.settings.favicon);
                this.placeholder_image_url = this.$mediaUrl(this.settings.placeholder_image);
                this.play_store_logo_url = this.$mediaUrl(this.settings.play_store_logo);
                this.ios_store_logo_url = this.$mediaUrl(this.settings.ios_store_logo);
