            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <h3  v-if="type === 'packet_products'">Packet Products</h3>
                        <h3  v-if="type === 'loose_products'">Loose Products</h3>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li v-if="type === 'packet_products'" class="breadcrumb-item active" aria-current="page">Packet Products</li>
                                <li v-if="type === 'loose_products'" class="breadcrumb-item active" aria-current="page">Loose Products</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 v-if="type === 'packet_products'" class="card-title">Packet Stock Products List</h4>
                        <h4 v-if="type === 'loose_products'" class="card-title">Loose Stock Products List</h4>
                        ...
                        <div class="table-responsive">
                            <b-table
                                ...
                                <template #cell(image)="row">
                                    <img :src="$mediaUrl(row.item.image)" height="50" v-if="row.item.image"/>
                                </template>
