                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <span class="pull-right">
                                <router-link to="/manage_sub_category_group/create" class="btn btn-primary">Add New Group</router-link>
                            </span>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <b-table
                                ...
                                <template #cell(actions)="row">
                                    <router-link :to="`/manage_sub_category_group/edit/${row.item.id}`" class="btn btn-sm btn-primary" v-b-tooltip.hover :title="__('edit')">
                                        <i class="fa fa-pencil-alt"></i>
                                    </router-link>
                                    <button class="btn btn-sm btn-danger" @click="deleteGroup(row.item.id)" v-b-tooltip.hover :title="__('delete')">
                    ...
                    axios.post(this.$apiUrl + '/group-sub-category/delete', { id })
                        .then(res => {
                            if(res.data.status === 1){
                                this.getGroups(); // Refresh the list from server
