                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <span class="pull-right">
                                ...
                                <button class="btn btn-primary" @click="$router.push('/super_mart_manage_category_group/create')">
                                    Add New Group
                                </button>
...
<script>
import CategoryGroupModal from './EditCategory.vue'; 

export default {
    components: {
        'category-group-modal': CategoryGroupModal
    },
    data() {
        return {
            groups: [],
