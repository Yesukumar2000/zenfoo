                        ...
                        <div class="table-responsive">
                            <b-table
                                ...
                                <template #cell(settlement_status)="row">
                                    <span :class="'badge ' + row.item.settlement_status_class">{{ row.item.settlement_status }}</span>
                                </template>
                            </b-table>
                        </div>
    ...
    data: function () {
        return {
            ...
            fields: [
                ...
                {key: 'admin_cash', label: __('admin_cash') +'('+ this.$currency +')', sortable: true, class: 'text-center'},
                {key: 'type', label: __('type'), sortable: true, class: 'text-center'},
                {key: 'settlement_status', label: __('settlement_status'), sortable: true, class: 'text-center'},
