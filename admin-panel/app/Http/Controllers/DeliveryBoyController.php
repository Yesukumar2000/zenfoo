...
class DeliveryBoyController extends BaseController
{
    ...
    public function getSettings(){
        ...
        // Driver-specific support contacts, falling back to the global pair.
        $settings["support_number"] = Setting::support_value('support_number', 'driver');
        $settings["support_email"] = Setting::support_value('support_email', 'driver');
