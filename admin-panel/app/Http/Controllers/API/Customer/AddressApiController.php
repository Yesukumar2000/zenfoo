...
class AddressApiController extends Controller
{
    ...
    public function save(Request $request){
        ...
        if (!$city) {
            return CommonHelper::responseError('We are not delivering to this location. The location is out of the delivery zone.');
        }
    ...
    public function update(Request $request){
        ...
        // Look the address up before clearing any default flags: bailing out
        // after the reset would leave the account with no default address,
        // which blocks checkout entirely.
