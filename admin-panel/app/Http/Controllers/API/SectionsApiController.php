...
class SectionsApiController extends Controller
{
    ...
    public function save(Request $request){
        ...
        if($request->hasFile('banner_app')){
            $section->banner_app = MediaUploadService::upload(
                $request->file('banner_app'),
        ...
        if($request->hasFile('banner_web')){
            $section->banner_web = MediaUploadService::upload(
                $request->file('banner_web'),
                'banner_section_style'
            );
        } else {
            $section->banner_web = '';
    ...
    public function update(Request $request){
        ...
        if(isset($request->id)){
            ...
            if($request->hasFile('banner_app')){
                $banner_app = MediaUploadService::upload(
                    $request->file('banner_app'),
                    'banner_section_style',
                    'public',
                    $section->banner_app
            ...
            if($request->hasFile('banner_web')){
                $banner_web = MediaUploadService::upload(
                    $request->file('banner_web'),
                    'banner_section_style',
                    'public',
                    $section->banner_web
