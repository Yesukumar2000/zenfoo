...
class SetLang {
	public function handle($request, Closure $next)
	{
        ...
        $restrictedUrls = array(
            ...
            'time_slots.saveTimeSlotsSettings','countries.save','countries.update','countries.delete','store_settings.save_store_basic_setting','store_settings.save_address_setting','store_settings.save_other_setting','store_settings.save_app_setting','store_settings.save_delivery_boy_setting','store_settings.save_frontend_home_setting','store_settings.save_smtp_mail_setting','store_settings.save_third_party_api_setting','store_settings.save_seller_setting','store_settings.save_refer_earn_setting','store_settings.save_additional_charges','store_settings.save_third_party_api_setting','store_settings.test_mail','store_settings.save_cart_setting'
        );
