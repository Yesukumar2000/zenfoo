...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: ['record'],
  data: function data() {
    var _this$record, _this$record2, _this$record3, _this$record4, _this$record5, _this$record6;
    return {
      isLoading: false,
      og_image: null,
      error: null,
      id: ((_this$record = this.record) === null || _this$record === void 0 ? void 0 : _this$record.id) || null,
      page_type: ((_this$record2 = this.record) === null || _this$record2 === void 0 ? void 0 : _this$record2.page_type) || '',
      meta_title: ((_this$record3 = this.record) === null || _this$record3 === void 0 ? void 0 : _this$record3.meta_title) || '',
      meta_keyword: ((_this$record4 = this.record) === null || _this$record4 === void 0 ? void 0 : _this$record4.meta_keyword) || '',
      schema_markup: ((_this$record5 = this.record) === null || _this$record5 === void 0 ? void 0 : _this$record5.schema_markup) || '',
      meta_description: ((_this$record6 = this.record) === null || _this$record6 === void 0 ? void 0 : _this$record6.meta_description) || '',
      ...
      pages: [{
        ...
        id: 5,
        name: __('Term condition')
      }, {
        id: 6,
        name: __('Product listing page')
      }, {
        id: 7,
        name: __('Privacy policy')
      }, {
        id: 8,
        name: __('Return exchange policy')
      }, {
        id: 9,
        name: __('Shipping policy')
      }, {
        id: 10,
        name: __('Cancellation policy')
      }]
    };
  },
  computed: {
    modal_title: function modal_title() {
      var title = this.id ? __('edit_seo_setting') : __('add_seo_setting');
      return title;
    }
  },
  methods: {
    ...
    saveRecord: function saveRecord() {
      ...
      var url = this.$apiUrl + (this.id ? '/seo_settings/update' : '/seo_settings/save');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    deleteSeoSettings: function deleteSeoSettings(index, id) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          ...
          axios.post(_this3.$apiUrl + '/seo_settings/delete', postData).then(function (response) {
            _this3.isLoading = false;
            var data = response.data;
            _this3.seo_settings.splice(index, 1);
    ...
    hideModal: function hideModal() {
      ...
      this.getSeoSettings();
      //this.$router.push({path: '/seo-settings'});
    },
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "form-group col-md-12" }, [
              ...
              _c(
                ...
                _vm._l(_vm.pages, function (page) {
                  return _c(
                    "option",
                    { key: page.id, domProps: { value: page.name } },
                    [
                      _vm._v(
                        "\n                        " +
                          _vm._s(page.name) +
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.meta_keyword,
                    expression: "meta_keyword",
                  },
                ],
                staticClass: "form-control",
                attrs: {
                  type: "text",
                  placeholder: _vm.__("enter_meta_keyword"),
                },
                domProps: { value: _vm.meta_keyword },
                on: {
                  input: function ($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.meta_keyword = $event.target.value
                  },
                },
              }),
            ]),
            ...
            _vm._v(" "),
            _c("div", { staticClass: "form-group col-md-12" }, [
              _c("label", [_vm._v(_vm._s(_vm.__("meta_description")))]),
              _vm._v(" "),
              _c("textarea", {
                directives: [
                  {
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("input", {
                ...
                attrs: { type: "file", name: "og_image", accept: "image/*" },
                ...
                [
                  _vm.og_image && _vm.og_image.name !== ""
                    ? [
                        _c("label", [
                          _vm._v(
                            "Selected file name:- " + _vm._s(_vm.og_image.name)
                          ),
                        ]),
                      ]
                    : [
