    ...
    updateStock: function updateStock(product_variant_id) {
      ...
      axios.post(this.$apiUrl + '/products/update_variant_stock', {
        ...
        if (response.data.status === 1) {
          ...
          _this3.getRecords(); // Refresh data after updating stock
        } else {
          _this3.showMessage('error', response.data.message);
        }
        _this3.edit_record = null; // Reset edit state
      })["catch"](function () {
        _this3.isLoading = false;
        _this3.showMessage('error', __('update_failed'));
      });
    }
  }
});
