    ...
    saveRecord: function saveRecord() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, formData, {
        ...
        if (data.status === 1) {
          ...
          // Show server message and bind row-level errors if provided
          vm.showError(data.message || 'Validation failed for some rows.');
          vm.rowErrors = Array.isArray(data.data) ? data.data : [];
                      ...
                      _c(
                        ...
                        [
                          _c("p", { staticClass: "mb-2" }, [
                            _vm._v(
                              "Validation failed for some rows. Please review and fix the following:"
                            ),
                          ]),
                          _vm._v(" "),
  ...
  function () {
    ...
    return _c("thead", [
      _c("tr", [
        _c(
          "th",
          { staticClass: "text-white", staticStyle: { width: "80px" } },
          [_vm._v("Row")]
        ),
        _vm._v(" "),
        _c("th", { staticClass: "text-white" }, [_vm._v("Errors")]),
      ]),
    ])
  },
]
