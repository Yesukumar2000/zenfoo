  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "page-content" }, [
      _c("section", { staticClass: "row" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-12 col-lg-7 col-md-12" }, [
            _c("div", { staticClass: "card h-90" }, [
              _c("div", { staticClass: "card-header" }, [
          ...
          _c(
            "div",
            { staticClass: "col-12 col-lg-5 col-md-12 products_sold" },
            [
              _c("div", { staticClass: "row" }, [
            ...
            _vm._l(_vm.record.status_order_count, function (status) {
              return _c(
                "div",
                {
                  key: status.status,
                  staticClass:
                    "col-12 col-sm-4 col-md-4 col-lg-2 col-xl-2 col-xxl-2 mb-2 mb-md-3",
                },
                [
                  _c("div", { staticClass: "card h-100" }, [
                    _c("div", { staticClass: "card-body p-2 p-sm-3" }, [
                      _c("div", { staticClass: "row align-items-center g-1" }, [
                        _c(
                          "div",
                          {
                            staticClass:
                              "col-4 col-sm-4 d-flex justify-content-center",
                          },
                          [
                        ...
                        _c("div", { staticClass: "col-8 col-sm-8" }, [
                          ...
                          status.status == "Ready for Pickup"
                            ? _c(
                                "h6",
                                { staticClass: "text-muted font-semibold" },
                                [_vm._v(_vm._s(_vm.__("ready_for_pickup")))]
                              )
                            : _vm._e(),
                          _vm._v(" "),
                          status.status == "Picked Up"
                            ? _c(
                                "h6",
                                { staticClass: "text-muted font-semibold" },
                                [_vm._v(_vm._s(_vm.__("picked_up")))]
                              )
                            : _vm._e(),
                          _vm._v(" "),
                              ...
                              [
                                ...
                                _c(
                                  "button",
                                  {
                                    ...
                                    on: {
                                      click: function ($event) {
                                        ;(_vm.deliveryDateRange.startDate =
                                          null),
                                          (_vm.deliveryDateRange.endDate =
                                            null),
                                          _vm.getLatestOrders()
                                      },
                                    },
