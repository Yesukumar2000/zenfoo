...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                if (!_this.drawingManager) {
                  ...
                  _this.drawingManager.setMap(_this.$refs.gmap.$mapObject);
                }
              case 4:
              case "end":
    ...
    getSellerCommission: function getSellerCommission() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$sellerApiUrl + '/seller_commission').then(function (response) {
        var data = response.data;
        _this4.commission = data.data.value;
      });
    },
    getStoreSettings: function getStoreSettings() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$apiUrl + '/store_settings').then(function (response) {
        ...
        _this5.store_settings = data.store_settingsObject;

        // Load store settings values
        data.store_settings.forEach(function (item) {
          if (item.variable === 'one_seller_cart') {
            _this5.store_settings.one_seller_cart = item.value === '1' ? 1 : 0;
          }
          if (item.variable === 'self_pickup_mode') {
            _this5.store_settings.self_pickup_mode = item.value === '1' ? 1 : 0;
          }
        });
      });
    },
              ...
              case 0:
                if (navigator.geolocation) {
                  navigator.geolocation.getCurrentPosition( /*#__PURE__*/function () {
                    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(position) {
                        ...
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              ...
                              _context2.next = 4;
                              return _this6.mapConfig({
                                lat: _this6.latitude,
                                lng: _this6.longitude
                              });
                            case 4:
                            case "end":
                    ...
                    _this6.showError("Geolocation is not supported or permission denied.");
                    console.error(error);
                  });
                } else {
                  _this6.showError("Geolocation is not supported by this browser.");
                }
              case 1:
              case "end":
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _this7.latitude = latLng.lat;
                _this7.longitude = latLng.lng;
                _context4.next = 5;
                return _this7.mapConfig(latLng);
              case 5:
              case "end":
              ...
              case 2:
                ...
                geocoder.geocode({
                  ...
                  if (status === "OK" && results[1]) {
                    var clickedPlace = results[1];
                    var addressArr = clickedPlace.formatted_address.split(",");
                    _this8.street = addressArr[0] + " " + (addressArr[1] || "");
                    _this8.place_name = addressArr[1] || "";
                    _this8.formatted_address = clickedPlace.formatted_address;
                    _this8.infoWindow = {
                      position: {
                        lat: _this8.latitude,
                        lng: _this8.longitude
                      },
                      template: "<b>".concat(_this8.place_name, "</b><br>").concat(_this8.formatted_address),
                      open: true
                    };
                    ...
                    _this8.markers = [marker];
                    _this8.center = marker.position;
                  } else {
    ...
    getSeller: function getSeller() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$apiUrl + '/sellers/edit/' + this.id).then(function (response) {
        ...
        var data = response.data;
        if (data.status === 1) {
          var _this10$record$admin$, _this10$record$admin$2, _this10$record$admin$3, _this10$record$city_i, _this10$record$catego;
          ...
          _this10.name = (_this10$record$admin$2 = _this10.record.admin.username) !== null && _this10$record$admin$2 !== void 0 ? _this10$record$admin$2 : _this10.record.name;
          _this10.email = (_this10$record$admin$3 = _this10.record.admin.email) !== null && _this10$record$admin$3 !== void 0 ? _this10$record$admin$3 : _this10.record.email;
          _this10.mobile = _this10.record.mobile;
          _this10.store_url = _this10.record.store_url;
          _this10.password = "";
          _this10.confirm_password = "";
          _this10.store_name = _this10.record.store_name;
          _this10.street = _this10.record.street;
          _this10.pincode_id = "";
          _this10.city_id = (_this10$record$city_i = _this10.record.city_id) === null || _this10$record$city_i === void 0 ? void 0 : _this10$record$city_i.split(",");
          _this10.categories_ids = (_this10$record$catego = _this10.record.categories) === null || _this10$record$catego === void 0 ? void 0 : _this10$record$catego.split(",");
          _this10.state = _this10.record.state;
          _this10.remark = _this10.record.remark;
          _this10.account_number = _this10.record.account_number;
          _this10.ifsc_code = _this10.record.bank_ifsc_code;
          _this10.bank_name = _this10.record.bank_name;
          _this10.account_name = _this10.record.account_name;
          _this10.commission = _this10.record.commission;
          _this10.tax_name = _this10.record.tax_name;
          _this10.tax_number = _this10.record.tax_number;
          _this10.pan_number = _this10.record.pan_number;
          _this10.latitude = _this10.record.latitude;
          _this10.longitude = _this10.record.longitude;
          _this10.place_name = _this10.record.place_name;
          _this10.formatted_address = _this10.record.formatted_address;
          _this10.store_description = _this10.record.store_description;
          ...
          // Self Pickup fields
          _this10.self_pickup_mode = _this10.record.self_pickup_mode || 0;
          _this10.pickup_store_address = _this10.record.pickup_store_address || "";
    ...
    saveRecord: function saveRecord() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post(url, formData, {
        headers: {
  ...
  mounted: function mounted() {
    ...
    this.$refs.mapRef.$mapPromise.then(function (map) {
      ...
      var defaultCenter = {
        lat: parseFloat(_this12.city.latitude) || 17.4486,
        lng: parseFloat(_this12.city.longitude) || 78.3908
      };
      _this12.center = defaultCenter;
      _this12.markers = [{
        position: defaultCenter
      }];
      _this12.infoWindow = {
        position: defaultCenter,
        template: "<b>".concat(_this12.city.name || "Default City", "</b><br>").concat(_this12.city.formatted_address || "Address"),
        open: true
      };
      ...
      var waitForDrawingLib = setInterval(function () {
        if (window.google && google.maps && google.maps.drawing) {
          ...
          _this12.initDrawingManager(); // initialize drawing
          if (_this12.city.boundary_points) {
            _this12.setMapOverlay(); // restore previous shapes
          }
        }
      }, 300);
    });
